 ...
 * marker, drawn as an SVG layer over the front photo (report_design_spec.md
 * calls for an SVG axis-line diagram here, unlike Proportions' plain-CSS
 * lines).
 */
export function SymmetryAxisOverlay({ photoUrl, overlay }: { photoUrl: string | null; overlay: FacialAssessment["overlay"] }) {
  ...
  return (
    <div className="relative overflow-hidden rounded-lg">
      ...
      <img src={photoUrl} alt="Your uploaded photo with the symmetry axis and mirrored points marked" className="block w-full" />
      <svg
        viewBox="0 0 100 100"
